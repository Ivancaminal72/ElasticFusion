...
class GPUConfig
{
    ...
    private:
           ...
           so3StepBlocks(64)
        {
            ...
            icpStepMap["TITAN X (Pascal)"] = std::pair<int, int>(240, 112);
            rgbStepMap["TITAN X (Pascal)"] = std::pair<int, int>(112, 80);
            rgbResMap["TITAN X (Pascal)"] = std::pair<int, int>(480, 112);
            so3StepMap["TITAN X (Pascal)"] = std::pair<int, int>(160, 160);
